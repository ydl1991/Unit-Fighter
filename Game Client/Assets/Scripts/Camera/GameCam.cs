...
public class GameCam : MonoBehaviour
{
    ...
    public void SetCameraToPlayer(Player player)
    {
        ...
        IController ct = player.GetComponentInChildren<IController>();
        if (ct != null && ct.type == ControllerType.kPlayer && ct.controllingPlayer.health > 0)
    ...
    public void ResetCam()
    {
        if (m_owner == null)
        {
            m_owner = GameManager.s_instance.GetPlayerController().ControllingPlayer();
        }
